...
## Overview
Лекция посвящена ключевым элементам дизайна экспериментов: от RCT и пайплайна проверки гипотез до выбора статистических критериев под различные типы метрик. Отдельное внимание уделено ошибкам 1 и 2 рода, определению MDE и типовым проблемам практических запусков.
На семинаре разбирается вывод доверительных интервалов для разных типов метрик, пример реализации A/B теста с z-критерием. Дополнительно планируется обсуждения дизайнов 3 тестов для разных сфер бизнеса.
...
27. [Интенсив ШАД по A/B тестам](https://github.com/dakhakimova/YSDA_ABweek/tree/main)
